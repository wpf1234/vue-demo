<!-- 推荐动态 -->
<template>
    <div class="friend row pre-scrollable"> 
         ...
         >   
             ...
             <v-list-item>
                 ...
                 <v-list-item-content>
                     ...
                     <v-list-item-subtitle>{{ item.tm | dateString }}</v-list-item-subtitle>
                 </v-list-item-content>
             </v-list-item>
 
             <!-- <v-carousel cycle height="160">
                 <v-carousel-item
                 v-for="(pic,i) in item.picture"
                 :key="i"
                 :src="pic"
             ...
             <v-card-actions>
                 ...
                 <v-icon 
                 class="mr-2" 
                 :style="{'color': `${item.like}` === 'true'? '#cf0000' : '#666'}" 
                 @click=""
                 >mdi-heart</v-icon>
                 <span class="subheading mr-3 pr-3">{{ item.favorite }}</span>
             ...
             <v-expand-transition max-height="200">
                 <v-list v-show="show" three-line>
                     <template v-for="comm in item.comm_list" >
                         <v-list-item>
                         <v-list-item-avatar>
